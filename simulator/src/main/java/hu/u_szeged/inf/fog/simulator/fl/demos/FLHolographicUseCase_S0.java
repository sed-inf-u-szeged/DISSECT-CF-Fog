...
public class FLHolographicUseCase_S0 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String tag = String.format("HolographicUseCaseS0_R%d_W%d_seed%d", ROUNDS, MODEL_DIMENSION_W, SEED);
        
        System.out.println("[HolographicUseCase_S0] Starting run with "
                + "Rounds=" + ROUNDS
                + ", |w|=" + MODEL_DIMENSION_W
                + ", seed=" + SEED
        ...
        aggregator.setFinishedCallback(() -> {
            ...
            System.out.println("[HolographicUseCase] Finished run " + tag + ". Exiting.");
