...
public class GuidedResourceAgent extends ResourceAgent {
    ...
    //TODO for merge: broadcast needs a null for the third parameter (decision maker), need a better solution.
    ...
    //TODO for merge: turn this into an interface that the others implement?
    @Override
