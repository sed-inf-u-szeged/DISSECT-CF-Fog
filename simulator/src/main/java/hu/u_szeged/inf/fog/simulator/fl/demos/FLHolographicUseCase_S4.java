 ...
 * ---- SCENARIO S4: PRIVACY & COMPRESSION -----
 */
public class FLHolographicUseCase_S4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String tag = String.format("HolographicUseCase_S4_R%d_W%d_seed%d", ROUNDS, MODEL_DIMENSION_W, SEED);
        
        System.out.println("[HolographicUseCase_S4] Starting run with "
                + "Rounds=" + ROUNDS
                + ", |w|=" + MODEL_DIMENSION_W
                + ", seed=" + SEED
        ...
        System.out.println("[HolographicUseCase_S4] Aggregator created, server repo ID: " + SERVER_REPO_ID);
        ...
        aggregator.setExportPaths(
                ScenarioBase.resultDirectory + "/fl_telemetry_S4__" + tag + ".csv",
                ScenarioBase.resultDirectory + "/fl_telemetry_S4__" + tag + ".png"
        );
        aggregator.setEnergyExportPaths(
                ScenarioBase.resultDirectory + "/fl_energy_S4__" + tag + ".csv",
                ScenarioBase.resultDirectory + "/fl_energy_S4__" + tag + ".png"
        );
        ...
        aggregator.setFinishedCallback(() -> {
            ...
            System.out.println("[HolographicUseCase_S4] Finished run " + tag + ". Exiting.");
        ...
        System.out.println("[HolographicUseCase_S4] Created " + flDevices.size() + " heterogeneous devices.");
        ...
        // ---------- 6) Kick off round 0 ----------
        System.out.println("[HolographicUseCase_S4] Starting FLOrchestrator for " + ROUNDS + " rounds...");
        new FLOrchestrator(
                ROUND_INTERVAL,
                ROUNDS,
                flDevices,
        ...
        System.out.println("[HolographicUseCase_S4] Simulation finished for " + tag);
    }
