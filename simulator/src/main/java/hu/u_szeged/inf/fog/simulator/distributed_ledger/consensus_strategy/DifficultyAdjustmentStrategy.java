...
/**
 * The DifficultyAdjustmentStrategy interface defines a method for computing the difficulty for the next block to be mined, based on the local chain, the block height, etc.
 */
public interface DifficultyAdjustmentStrategy {
    /**
     * Computes the difficulty for the next block to be mined, based on the local chain, the block height, etc.
     *
