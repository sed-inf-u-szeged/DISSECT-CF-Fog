...
public class CBBAResourceAgent extends ResourceAgent {
    ...
    public void pruneBundle(AgentApplication app) {
        ...
        //we don't necessarily need to remove them, it will be cleared anyway, but it will stay for the sake of messages (for debugging)
    ...
    public void exchangeOriginal(CBBAResourceAgent other, Resource res) {
