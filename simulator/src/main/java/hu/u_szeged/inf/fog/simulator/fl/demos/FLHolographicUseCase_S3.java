...
public class FLHolographicUseCase_S3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final double MIN_COMPLETION_RATE  = 1.0;  //  Aggregate if 75% of expected (post-dropout) clients arrive
        ...
        String tag = String.format("HolographicUseCase_S3_R%d_W%d_seed%d", ROUNDS, MODEL_DIMENSION_W, SEED);
        
        System.out.println("[HolographicUseCase_S3] Starting Policy run with "
                + "Rounds=" + ROUNDS
                + ", |w|=" + MODEL_DIMENSION_W
                + ", seed=" + SEED
        ...
        aggregator.setExportPaths(
                ScenarioBase.resultDirectory + "/fl_telemetry_S3__" + tag + ".csv",
                ScenarioBase.resultDirectory + "/fl_telemetry_S3__" + tag + ".png"
        );
        aggregator.setEnergyExportPaths(
                ScenarioBase.resultDirectory + "/fl_energy_S3__" + tag + ".csv",
                ScenarioBase.resultDirectory + "/fl_energy_S3__" + tag + ".png"
        );
        ...
        aggregator.setFinishedCallback(() -> {
            ...
            System.out.println("[HolographicUseCase_S3] Finished run " + tag + ". Exiting.");
        ...
        boolean fixedCadence = false; // CHANGE PACING HERE FOR SCENARIO_S3
        ...
        // ---------- 6) Kick off round 0 ----------
        System.out.println("[HolographicUseCase_S3] Starting FLOrchestrator for " + ROUNDS + " rounds...");
        new FLOrchestrator(
                ROUND_INTERVAL,
                ROUNDS,
                flDevices,
        ...
        System.out.println("[HolographicUseCase_S3] Simulation finished for " + tag);
    }
