...
public class WorkflowSimulation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WorkflowComputingAppliance node1 = new WorkflowComputingAppliance(cloudfile, "node1", new GeoLocation(48.8566, 2.3522), 0);  
        WorkflowComputingAppliance node2 = new WorkflowComputingAppliance(cloudfile, "node2", new GeoLocation(51.5074, -0.1278), 0);  
        WorkflowComputingAppliance node3 = new WorkflowComputingAppliance(cloudfile, "node3", new GeoLocation(52.5200, 13.4050), 0);  
        WorkflowComputingAppliance node4 = new WorkflowComputingAppliance(cloudfile, "node4", new GeoLocation(41.9028, 12.4964), 0);  
        WorkflowComputingAppliance node5 = new WorkflowComputingAppliance(cloudfile, "node5", new GeoLocation(41.0082, 28.9784), 0);  
        WorkflowComputingAppliance node6 = new WorkflowComputingAppliance(cloudfile, "node6", new GeoLocation(43.7102, 7.2620), 0); 
        WorkflowComputingAppliance node7 = new WorkflowComputingAppliance(cloudfile, "node7", new GeoLocation(55.6761, 12.5683), 0);  
        WorkflowComputingAppliance node8 = new WorkflowComputingAppliance(cloudfile, "node8", new GeoLocation(59.3293, 18.0686), 0);  
        WorkflowComputingAppliance node9 = new WorkflowComputingAppliance(cloudfile, "node9", new GeoLocation(48.2082, 16.3738), 0); 
        WorkflowComputingAppliance node10 = new WorkflowComputingAppliance(cloudfile, "node10", new GeoLocation(50.8503, 4.3517), 0);  
        WorkflowComputingAppliance node11 = new WorkflowComputingAppliance(cloudfile, "node11", new GeoLocation(46.7762, 23.6213), 0);  
        WorkflowComputingAppliance node12 = new WorkflowComputingAppliance(cloudfile, "node12", new GeoLocation(48.1351, 11.5820), 0);  
        WorkflowComputingAppliance node13 = new WorkflowComputingAppliance(cloudfile, "node13", new GeoLocation(53.9076, 27.5754), 0);  
        WorkflowComputingAppliance node14 = new WorkflowComputingAppliance(cloudfile, "node14", new GeoLocation(60.1695, 24.9354), 0); 
        WorkflowComputingAppliance node15 = new WorkflowComputingAppliance(cloudfile, "node15", new GeoLocation(39.9334, 32.8597), 0); 
        WorkflowComputingAppliance node16 = new WorkflowComputingAppliance(cloudfile, "node16", new GeoLocation(40.4168, -3.7038), 0);  
        WorkflowComputingAppliance node17 = new WorkflowComputingAppliance(cloudfile, "node17", new GeoLocation(37.9838, 23.7275), 0);  
        WorkflowComputingAppliance node18 = new WorkflowComputingAppliance(cloudfile, "node18", new GeoLocation(52.3702, 4.8952), 0);  
        WorkflowComputingAppliance node19 = new WorkflowComputingAppliance(cloudfile, "node19", new GeoLocation(55.9533, -3.1883), 0); 
        WorkflowComputingAppliance node20 = new WorkflowComputingAppliance(cloudfile, "node20", new GeoLocation(51.1657, 10.4515), 0); 
        ...
        new EnergyDataCollector("node-20", node20.iaas, true);
