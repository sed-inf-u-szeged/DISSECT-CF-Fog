...
public class NaiveResourceAgent {

    public static ArrayList<NaiveResourceAgent> agentList = new ArrayList<NaiveResourceAgent>();
    ...
    public NaiveResourceAgent(Repository repo, ArrayList<Constraint> constraints) {
        this.repo = repo;
        ...
        NaiveResourceAgent.agentList.add(this);
    }
    ...
    public void broadcast(BroadcastMessage bm, boolean serviceable) {
        ...
        ArrayList<NaiveResourceAgent> agentsToBeAcknowledged = new ArrayList<>(bm.alreadyVisitedAgents);
        ...
        if (solutionFound == false && bm.alreadyVisitedAgents.size() == NaiveResourceAgent.agentList.size()) {
        ...
        if (solutionFound == false && deadEnd == false) {
            ...
            ArrayList<NaiveResourceAgent> neighbors = new ArrayList<>(NaiveResourceAgent.agentList);
            neighbors.removeAll(bm.alreadyVisitedAgents);
            
            this.decreaseAcknowledgement(agentsToBeAcknowledged, null, bm.size);

            for (NaiveResourceAgent agent : neighbors) {
    ...
    private void increaseAcknowledgement(ArrayList<NaiveResourceAgent> agentsToBeAcknowledged, long msgSize) {
    ...
    private void decreaseAcknowledgement(ArrayList<NaiveResourceAgent> agentsToBeAcknowledged, ArrayList<Pair> solution, 
            long msgSize) {
