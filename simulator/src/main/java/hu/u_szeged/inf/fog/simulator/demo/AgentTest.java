...
public class AgentTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Total msg count: "             + BroadcastMessage.totalMessageCount 
		                 ...
		                 + " Worst case (ack / br): "      + BroadcastMessage.calculateTotalBrMessages(ResourceAgent.agentList.size()) * 2
	 ...
	 public static void generateResources(int numberOfResources, long repoSize, long bandwidth, HashMap<String, Integer> latencyMap,
	        ...
	        ArrayList<ResourceAgent> agents = new ArrayList<>();
	        ...
	        for (int i = 0; i < numberOfResources; i++) {
	            ...
	            ResourceAgent ra =  new ResourceAgent(new Repository(repoSize, name, bandwidth, bandwidth, bandwidth, latencyMap,
	        ...
	        for (ResourceAgent resource : agents) {
