...
import hu.u_szeged.inf.fog.simulator.prediction.Events;
...
public class PredictorApplication extends IApplication {
    ...
    public String getProjectLocation() {
        return new StringBuilder(System.getProperty("user.dir"))
                ...
                .append("resources").append(File.separator).append("prediction").append(File.separator).append("scripts")
                .append(File.separator).toString();
    }

    @Override
    public Process openWindows() throws Exception {
        return Runtime.getRuntime().exec(String.format("C:/Windows/System32/cmd.exe /c cd %s & start python.exe main.py", getProjectLocation()));
    }
