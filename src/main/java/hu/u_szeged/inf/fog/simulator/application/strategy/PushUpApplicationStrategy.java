...
public class PushUpApplicationStrategy extends ApplicationStrategy{
	...
	public void findApplication(long dataForTransfer) {
		if (this.application.computingAppliance.parent != null) {
			Application chosenApplication = this.application.computingAppliance.applications.get(SeedSyncer.centralRnd.nextInt(this.application.computingAppliance.parent.applications.size()));
